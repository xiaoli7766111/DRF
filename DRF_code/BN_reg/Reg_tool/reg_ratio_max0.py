...
default_ratio = {
    # 列表
    # 'v16': [0., 0., 0.1, 0.1, 0.5, 0.5, 0.5, 0.65, 0.65, 0.65, 0.5, 0.5, 0.],
    # 'v16': [0., 0., 0.1, 0.1, 0.53, 0.53, 0.53, 0.65, 0.65, 0.65, 0.53, 0.53, 0.],
    # 'v16': [0., 0., 0.1, 0.1, 0.53, 0.53, 0.53, 0.65, 0.65, 0.65, 0.53, 0.53, 0.],
    'v16': [0., 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.38, 0.38, 0.38, 0.18, 0.18, 0.],
    # 'v16': [0., 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.4, 0.4, 0.4, 0.21, 0.21, 0.],
    # 'v19': [0., 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.4, 0.4, 0.4, 0.4, 0.21, 0.21, 0.21, 0.],
    # 'v19': [0., 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.4, 0.4, 0.4, 0.4, 0.25, 0.25, 0.25, 0.],
    'v19': [0., 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.4, 0.4, 0.4, 0.4, 0.21, 0.21, 0.21, 0.],

    # 'r18': [0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0, 0.6, 0.0],
    'r18': [0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0, 0.4, 0.0],
}

parser = argparse.ArgumentParser()
parser.add_argument('--pattern', type=str, default='r18', help='the pattern for net param')
