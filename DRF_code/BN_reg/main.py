...
parser.add_argument('--save', default='./logs_baseline/r18', type=str, help='path to save prune model')

# model layers
parser.add_argument('--arch', default='Resnet', type=str, help='(Vgg LeNet Resnet)')
