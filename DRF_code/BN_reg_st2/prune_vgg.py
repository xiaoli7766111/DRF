...
import numpy as np
from BN_reg.models.Vgg import *
from BN_reg.Reg_tool import prun_reg
...
parser.add_argument('--depth', default=19, type=int, help='depth of network Vgg(19), Resnet(18/50/101)')

parser.add_argument('--model', default='NNNxxx/v19/ssl9/Vgg_cifar10_100.model', type=str,
                    help='path to the model (default: none)')

parser.add_argument('--save', default='NNNxxx/prune/v19/ssl9', type=str,
...
filter_tap = prun_reg.filter_gl(model)
