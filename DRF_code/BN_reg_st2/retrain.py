...
import random
import time
from DRF_code.BN_reg.Main_tool import dataset, sparsity
...
parser.add_argument('--save', default='NNNxxx/prune/v19/ssl9', type=str, metavar='PATH',
...
parser.add_argument('--refine', default='NNNxxx/prune/v19/ssl9/pruned.pth', type=str, metavar='PATH',
