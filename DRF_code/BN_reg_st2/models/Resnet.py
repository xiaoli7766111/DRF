    ...
    def __init__(self, depth=None, dataset='cifar10', cfg=None):
        ...
        if depth == 50:
            self.layer1 = nn.Sequential(BaseRestBlock_Downsample(cfg[0:4], [1, 1]),  # 残差块 图像大小 不变
                                        ...
                                        BaseRestBlock_Downsample(cfg[6:10], [1, 1]))  # (64, 64, (3, 3)) * 2
            ...
            self.layer1 = nn.Sequential(RestBlock_Downsample(cfg[0:3], [1, 1]),  # 残差块 图像大小 不变
                                        RestBlock_Downsample(cfg[2:5], [1, 1]))  # (64, 64, (3, 3)) * 2
