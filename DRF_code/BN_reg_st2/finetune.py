...
import random
import time
from Reg_tool import reg_ratio_max0
from DRF_code.BN_reg_st2.Main_tool import dataset, sparsity
...
parser.add_argument('--save', default='NNNxxx/v16_A/rat32', type=str, metavar='PATH',
...
parser.add_argument('--refine', default='logs_baseline/v16/Vgg_cifar10_200.model', type=str, metavar='PATH',
                    help='path to the pruned model to be inc4 tuned')

parser.add_argument('--thre', default=0.0009, type=int, help='the threshold of network')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        mm = reg_ratio_max0.jj(model)
        savepath = os.path.join(args.save, f"filter.excel")
